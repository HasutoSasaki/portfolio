...
<template>
  ...
  <section class="grid grid-cols-2 gap-10">
    <div v-for="project in data.viewer.repositories.nodes" :key="project.id" class="p-8 border-4
        my-4 rounded-lg hover:bg-gray-50">
      ...
      <div class="mt-4">
        ...
        <Icon name="system-uicons:branch" size="1.1rem" class="text-indigo-700" />Forks:{{ project.forks.totalCount
        }}
