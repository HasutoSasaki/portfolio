<template>
    ...
    <p class="text-lg">
        I am often asked about the gear I use as a software developer and content creator. The hardware and software I use
        is
        changing all the time so this page will serve as a place for an updated list. If you have a question about anything
        I
    ...
    <ul class="list-disc">
        <li class="ml-8 py-1"><a href="https://code.visualstudio.com/" aria-label="Visual Studio Code">Visual Studio
                Code</a>
            is my current
            editor and I use it for pretty much everything.</li>
        <li class="ml-8 py-1">The theme I am currently using is
